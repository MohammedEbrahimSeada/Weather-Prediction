    ...
    <header className="bg-white dark:bg-dark-secondary border-b border-gray-200 dark:border-dark-border sticky top-0 z-10 backdrop-blur-sm bg-opacity-90 dark:bg-opacity-90">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          >
            <Satellite className="w-8 h-8 text-nasa-blue" />
            <div className="text-left">
              <h1 className="text-xl font-bold text-gray-900 dark:text-text-primary">WeatherProb</h1>
              <p className="text-xs text-gray-600 dark:text-text-tertiary">NASA Earth Observation Analysis</p>
            </div>
          </button>
